...
type ProAction interface {
	...
	GetHoldingERC20Tokens(address string, page, offset *int) (tokens []HoldingERC20, err error)
	GetHoldingERC721Tokens(address string, page, offset *int) (tokens []HoldingERC721, err error)
	GetERC721Inventory(wallet, contract string, page, offset *int) (tokens []ERC721Inventory, err error)
}

type Action interface {
	explorer.Module
	// EtherBalance gets ether balance for a single address
	EtherBalance(address string) (balance *utils.BN, err error)
	...
	ERC20Balance(address string, contractAddress string) (balance *utils.BN, err error)
	ProAction
}
